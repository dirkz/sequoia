...
a_cutoff_list!(AsymmetricAlgorithmCutoffList, AsymmetricAlgorithm, 23,
               [
                   ...
                   Some(Timestamp::Y2024M2), // 5. ElGamal2048.
                   Some(Timestamp::Y2024M2), // 6. ElGamal3072.
                   Some(Timestamp::Y2024M2), // 7. ElGamal4096.
                   Some(Timestamp::Y2014M2), // 8. DSA1024.
                   Some(Timestamp::Y2024M2), // 9. DSA2048.
                   Some(Timestamp::Y2024M2), // 10. DSA3072.
                   Some(Timestamp::Y2024M2), // 11. DSA4096.
                   ACCEPT,                   // 12. NistP256.
                   ACCEPT,                   // 13. NistP384.
                   ACCEPT,                   // 14. NistP521.
...
a_cutoff_list!(SymmetricAlgorithmCutoffList, SymmetricAlgorithm, 14,
               [
                   ...
                   Some(Timestamp::Y2024M2), // 1. IDEA.
                   Some(Timestamp::Y2017M2), // 2. TripleDES.
                   Some(Timestamp::Y2024M2), // 3. CAST5.
                   ACCEPT,                   // 4. Blowfish.
                   REJECT,                   // 5. Reserved.
                   REJECT,                   // 6. Reserved.
                   ACCEPT,                   // 7. AES128.
